...
На сервере работает Beta версия программного обеспечения (развёрнуто в Docker на Raspberry Pi). По каждому датчику глубина архива составляет 1000 показаний в данной версии программы. Архив пишется "по-кругу".
